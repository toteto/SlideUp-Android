...
public class SlideEndViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slide_end_view);
        ...
        sliderView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toast = Toast.makeText(SlideEndViewActivity.this, "click", Toast.LENGTH_SHORT);
                toast.show();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_slide_end_view, menu);
        return true;
    }
